...
function add_css(target) {
  append_styles(target, "svelte-we838v", ".card.svelte-we838v.svelte-we838v{position:absolute;background-color:var(--background-primary-alt);border:1px solid var(--background-modifier-border);padding:var(--card-padding);word-wrap:break-word;overflow-y:hidden;margin:0;transition-property:transform;transition-duration:0.4s;transform:translate(0, 100vh)}.card.skip-transition.svelte-we838v.svelte-we838v{transition:none}.card.svelte-we838v.svelte-we838v{font-size:0.8rem}.card.svelte-we838v p,.card.svelte-we838v ul{margin:0.3rem 0}.card.svelte-we838v h1,.card.svelte-we838v h2,.card.svelte-we838v h3{margin:0 0 0.3rem}.card.svelte-we838v ul{padding-left:var(--size-4-5)}.card.svelte-we838v.svelte-we838v:hover{border-color:var(--background-modifier-border-hover)}.card.svelte-we838v h3.svelte-we838v{word-wrap:break-word}.card.svelte-we838v .card-info.svelte-we838v{margin:calc(-1 * var(--card-padding));margin-top:0;border-top:1px solid var(--background-modifier-border);padding:var(--size-4-1) var(--card-padding);background-color:var(--background-primary);display:flex;flex-direction:row;align-items:center;justify-content:end;gap:var(--size-4-1)}.card.svelte-we838v .card-info .folder-name.svelte-we838v{flex-grow:1}");
}
function create_if_block(ctx) {
  ...
  return {
    c() {
      ...
      span1 = element("span");
      t = text(t_value);
      attr(span1, "class", "folder-name svelte-we838v");
    },
    m(target, anchor) {
...
function create_fragment(ctx) {
  ...
  return {
    c() {
      ...
      attr(h3, "class", "svelte-we838v");
      attr(button, "class", "clickable-icon");
      attr(div1, "class", "card-info svelte-we838v");
      attr(div2, "class", "card svelte-we838v");
      attr(div2, "role", "link");
